...
@Slf4j
@Component
public class TaskDataBaseMariaDB implements TaskDataBase {
    ...
    public void printValuesDataBase() {
        ...
        log.info("###############DATABASE MARIADB######################");
        log.info("all subjects {}: {}", subjects.size(), subjects);
        log.info("all teachers {}: {}", teachers.size(), teachers);
        log.info("###############DATABASE MARIADB######################\n");
    }
}
